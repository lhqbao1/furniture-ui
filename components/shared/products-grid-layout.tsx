...
const ProductsGridLayout = ({ hasBadge, hasPagination }: ProductsGridLayoutProps) => {
                ...
                {trendingProducts.map((product, idx) => {
                    return (
                        ...
                        >
                            ...
                            {hasBadge &&
                                <div className='absolute top-3 left-4 rounded-xl text-xs py-1 uppercase px-2 text-white bg-[#8cc63f]'>
                                    Top Featured
                                </div>
                            }
