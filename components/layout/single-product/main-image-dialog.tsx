                ...
                <div className="grid grid-cols-12 gap-6 h-full">
                    ...
                    >
                        <Image
                            ...
                            width={800}
                            height={800}
                            className={`object-contain h-full w-full transition-transform duration-300 ${zoom ? "scale-200 cursor-zoom-out" : "scale-100"
                                }`}
                            style={
                                zoom
                                    ? {
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            {productDetails.static_files.map((file, idx) => (
                                <button
                                    ...
                                    className={`border-2 rounded-md p-2 overflow-hidden ${mainImageIndex === idx
                                        ? "border-primary"
                                        : "border-gray-200"
                                        }`}
                                >
