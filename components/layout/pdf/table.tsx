                    ...
                    {table.getRowModel().rows?.length ? (
                        <>
                            ...
                            <TableRow>
                                ...
                                <TableCell className="text-start">€{coupon ? coupon?.toFixed(2) : DEFAULT_SALE.toFixed(2)}</TableCell>
                            </TableRow>
                            <TableRow>
                                ...
                                <TableCell className="text-center pr-6">1</TableCell>
                                <TableCell className="text-right"></TableCell>
                                <TableCell className="text-start">€{voucher ? voucher.toFixed(2) : DEFAULT_SALE.toFixed(2)}</TableCell>
                            </TableRow>
                        </>
                    ) : (
                        <TableRow>
