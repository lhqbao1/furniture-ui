...
import { dspSidebarLockedAtom } from "@/store/admin-sidebar";
  ...
  const items = [
    {
      ...
      children: [
        {
          title: "Add Product",
          url: "/dsp/admin/products/add",
          icon: CornerDownRight,
        },
        {
          title: "Product List",
          url: "/dsp/admin/products/list",
          icon: CornerDownRight,
        },
      ],
    },
    {
      ...
      children: [
        {
          title: "Preparing",
          url: "/dsp/admin/orders/list/preparing",
          icon: CornerDownRight,
        },
        {
          title: "Dispatched",
          url: "/dsp/admin/orders/list/dispatched",
          icon: CornerDownRight,
        },
        {
          title: "Canceled",
          url: "/dsp/admin/orders/list/canceled",
          icon: CornerDownRight,
        },
        {
          title: "Returned",
          url: "/dsp/admin/orders/list/returned",
          icon: CornerDownRight,
        },
