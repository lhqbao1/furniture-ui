...
const CancelWrongPriceDialog = ({
  id,
  status,
  open,
  onClose,
}: ReturnConfirmDialogProps) => {
  const cancelOrderMutation = useCancelWrongPriceOrder();
    ...
    >
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to cancel this order because of wrong price?
...
export default CancelWrongPriceDialog;
