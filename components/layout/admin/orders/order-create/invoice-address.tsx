...
const ManualCheckOutInvoiceAddress = ({ isAdmin = false }: CheckOutInvoiceAddressProps) => {
    ...
    const shippingAddressLine = useWatch({ name: "address", control: form.control })
    const shippingPostalCode = useWatch({ name: "postal_code", control: form.control })
