...
const SelectOrderItems = () => {
    ...
    const handleSelectProduct = (product: ProductItem) => {
        setListProducts((prev) => {
            ...
            return [...prev, { product, quantity: 1, final_price: product.final_price ?? 0 }]
        })
    }
            ...
            <div className="flex gap-2 items-center">
                <Popover open={open} onOpenChange={setOpen}>
                    <PopoverTrigger asChild>
                        <Button variant="outline" className="flex-1 justify-between py-1 h-12">
                            Select Products
                        </Button>
                    </PopoverTrigger>
                        ...
                        >
                            <div className="flex items-center gap-3 col-span-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground">#{product.id_provider}</div>
                                </div>
                            </div>
