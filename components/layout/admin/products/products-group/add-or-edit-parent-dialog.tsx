...
import { useAddProductGroup, useUpdateProductGroup } from '@/features/product-group/hook'
...
const AddOrEditParentDialog = ({ dialogOpen, setDialogOpen, groupName, setGroupName, defaultValues }: AddOrEditParentDialogProps) => {
    ...
    const handleAddOrEditProductGroup = (name: string) => {
        if (defaultValues) {
            editProductGroupMutation.mutate({ name: name, id: defaultValues.id }, {
                onSuccess: () => {
