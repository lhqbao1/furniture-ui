...
export const STATUS_OPTIONS = [
  ...
  { key: "exchange", label: "Exchange", active: true, pos: 10 },
  { key: "canceled_no_stock", label: "Cancel no stock", active: true, pos: 11 },
  {
...
export const STATUS_ACTIVE_RULES: Record<string, string[]> = {
  ...
  canceled_no_stock: ["return_issue", "canceled", "exchange"],
...
export const SHIPMENT_CARRIERS = [
  ...
  { id: "cargoline", logo: "/cargoline.webp", label: "Cargoline" },
  ...
  { id: "other", logo: null, label: "Other" },
] as const;
