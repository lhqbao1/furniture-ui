...
export const CreateOrderSchema = (t: (key: string) => string) => z.object({
  ...
  terms: z.boolean().refine((val) => val === true, { message: t("must_accept_terms") }),
...
export type CreateOrderFormValues = z.infer<ReturnType<typeof CreateOrderSchema>>
